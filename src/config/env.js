...
// Trailing slash is normalized so new URL() resolves relative paths predictably.
const storeBaseUrl = (
  process.env.STORE_BASE_URL || 'https://the-modern-groom-dev-bcbxaupc.myshopify.com/'
).replace(/\/?$/, '/');
...
/** Builds an absolute store URL pinned to the configured Shopify preview theme. */
...
export const env = {
  ...
  // Saved browser sessions written by the setup projects
